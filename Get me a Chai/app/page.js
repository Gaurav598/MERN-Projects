    ...
    <>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
          ...
          {/* Description Text */}
          <div className="text-lg text-center max-w-2xl mx-auto px-4">
            <p className="mb-4">
              ...
              endeavors by buying you a chai.
            </p>
            <p>
              Unlock the potential of your fanbase and bring your projects to
              life. Engage with your fans on a more personal level and receive
